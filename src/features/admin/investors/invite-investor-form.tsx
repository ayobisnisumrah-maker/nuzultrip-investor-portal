    ...
    <form action={submit} className="space-y-5">
      <div className="space-y-2">
        ...
        <p className="text-caption text-fg-subtle">
          Menentukan profil awal investor. Status awal tetap prospektif/draft sesuai lifecycle sistem.
        </p>
      </div>
      ...
      <div className="space-y-2">
        ...
        />
        <p className="text-caption text-fg-subtle">
          Sistem mengirim tautan aktivasi ke surel ini. Investor membuat kata sandinya sendiri; admin tidak mengetahui kata sandi investor.
        </p>
      </div>
