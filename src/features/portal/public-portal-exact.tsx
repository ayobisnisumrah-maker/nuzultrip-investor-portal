...
import { ArrowRight, Building, Building2, Compass, Disc as TikTokIcon, FileDown, Globe2, Handshake, Luggage, Phone, Users } from 'lucide-react'
...
function InstagramBrandIcon() {
  return <svg aria-hidden="true" viewBox="0 0 24 24" width="17" height="17" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="3" width="18" height="18" rx="5"/><circle cx="12" cy="12" r="4"/><circle cx="17.5" cy="6.5" r="1" fill="currentColor" stroke="none"/></svg>
}

function FacebookBrandIcon() {
  return <svg aria-hidden="true" viewBox="0 0 24 24" width="17" height="17" fill="currentColor"><path d="M13.7 21v-8h2.7l.4-3h-3.1V8.1c0-.9.3-1.5 1.6-1.5H17V4a22 22 0 0 0-2.4-.1c-2.4 0-4.1 1.5-4.1 4.2V10H8v3h2.5v8h3.2Z"/></svg>
}
...
function Footer({ navigation, logoSrc, content }: { navigation: NavItem[]; logoSrc: string; content?: Record<string, unknown> }) {
  ...
  return <footer id="site-footer" className="bg-[#080808] text-white pt-16 sm:pt-20 pb-12 border-t border-white/10"><div className="w-full mx-auto px-5 sm:px-8 md:px-12 lg:px-16 max-w-[1320px]">
    ...
    <div className="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-[13px] text-white/50"><p>© 2026 Nuzultrip. All Rights Reserved.</p><p className="text-center sm:text-right">{text(content?.footer_bottom_text)||'Platform Penawaran Equity Ekosistem Perjalanan Muslim Indonesia.'}</p></div>
  </div></footer>
}
