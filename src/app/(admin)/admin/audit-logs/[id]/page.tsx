      ...
      <PageHeader
        ...
        description={
          <span className="flex flex-wrap items-center gap-x-3 gap-y-1">
            ...
            <span>{actorTypeLabel(audit.actor_type)}</span>
              ...
              <DetailList>
                ...
                <DetailRow label="Entity">
                  <div className="flex flex-col gap-1">
                    ...
                    {audit.entity_id ? (
                      <span className="text-caption text-fg-subtle font-mono break-all">
                        {audit.entity_id}
                      </span>
                    ) : null}
                  </div>
                ...
                <DetailRow label="Ringkasan">
                  <span className="whitespace-pre-wrap">{audit.summary || '—'}</span>
                </DetailRow>
              </DetailList>
            </CardBody>
          </Card>
          ...
          <Card className="motion-safe:animate-rise">
            ...
            <CardBody>
              {audit.changes && Object.keys(audit.changes).length > 0 ? (
                <pre className="border-border bg-sunken text-caption text-fg overflow-x-auto rounded-lg border p-4 font-mono leading-relaxed">
