...
revoke all on function app.create_investor_message_thread(uuid, text, text) from public, anon;
grant execute on function app.create_investor_message_thread(uuid, text, text) to authenticated;
