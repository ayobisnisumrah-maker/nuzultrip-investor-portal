-- =============================================================================
-- Document creation with optional file asset
--
-- Extends the atomic document creation workflow so the initial draft version
-- can reference an already-finalized media asset.
-- =============================================================================
...
begin
  ...
  /*
   * If a file was uploaded, verify that it is a finalized asset belonging
   * to the authenticated administrator and is not already attached to a
   * document version.
   */
  if p_file_asset_id is not null then
    ...
    where id = p_file_asset_id
      and uploaded_by = v_admin_id
