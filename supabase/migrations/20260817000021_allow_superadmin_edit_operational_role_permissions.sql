-- =============================================================================
-- Allow Super Admin to manage permissions of operational system roles.
--
-- Super Admin itself remains immutable.
-- System role identity remains protected by the application/server layer.
-- Permission membership may be changed by an authorized Super Admin.
-- =============================================================================
