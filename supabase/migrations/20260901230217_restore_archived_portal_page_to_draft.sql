-- =============================================================================
-- Restore archived portal pages back to draft
--
-- Allows:
--   archived -> draft
--
-- When restoring an archived page, published section versions are preserved as
-- immutable history. Fresh draft copies become the current editable versions.
-- =============================================================================
...
begin
  ...
  if p_to_status = 'review' then
    ...
    -- archived -> draft
    --
    -- Published versions must remain immutable. Therefore, create a new draft
    -- copy for each current published section version and make it editable.
    -- -------------------------------------------------------------------------
...
is
'Atomically transitions portal pages through the publication lifecycle, including restoring archived pages to editable draft copies.';